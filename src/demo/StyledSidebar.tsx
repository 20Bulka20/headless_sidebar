    ...
    >
      ...
      >
        ...
        <SidebarSubMenu
          ...
          panelBackdropClassName="fixed inset-0 z-50 bg-black/30 opacity-0 pointer-events-none transition-opacity duration-300 data-open:opacity-100 data-open:pointer-events-auto"
          panelClassName="fixed inset-x-0 bottom-0 z-50 rounded-t-2xl bg-white shadow-lg translate-y-full transition-transform duration-300 ease-out data-open:translate-y-0"
